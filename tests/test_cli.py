...
def test_clean_runs_only_after_generation_succeeds(tmp_path):
    ...
    existing_output = tmp_path / "existing.txt"
    original_contents = dedent("""\
    # This file is generated by `rapids-dependency-file-generator`.
    existing contents
    """)
    existing_output.write_text(original_contents)
    ...
    assert existing_output.read_text() == original_contents
